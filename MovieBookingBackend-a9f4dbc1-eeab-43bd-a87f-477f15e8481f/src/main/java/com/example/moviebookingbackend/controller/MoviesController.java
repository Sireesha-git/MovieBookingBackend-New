...
import com.example.moviebookingbackend.model.MoviesModel;
...
public class MoviesController {
    ...
    public Movies addProduct(@RequestBody MoviesModel moviesModel) {
        Movies movies=new Movies(moviesModel);
